...
//    private final int INPUT_KEYBOARD = 1;
    ...
    private class AlgoPanel extends JPanel {
        ...
        String[] text = new String[]{
            ...
            + "such that no point in the plane is inside the circumcircle of any\n "
            ...
            + "structure was used. At first, we set a big triangle in the plane which is much bigger\n "
            ...
            + "to partition the plane. Firstly, we calculate the Delaunay center of an arbitrary\n "
            + "leaf in the structure. We draw lines to the Delaunay centers of its neighbouring\n "
            + "triangles and incrementally use the construction of the Voronoi diagram to calculate\n "
